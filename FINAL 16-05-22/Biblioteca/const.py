...
OPTIONS:
    ...
    a) Add book to Library Cataloge.
    b) Watch book list or client list.
    c) Add a client to client list.
    d) Assign a book to a client.
    e) Watch Assigned books.
    f) Add book list to file.
    g) Delete book from cataloge.
    i) Delete book list from file.
...
This is a software of a Library. Here you can explore
the Book's cataloge, add another books, upload to a DB
and choose any kind of books you want.

To do so, you need to choose the correct option of the 
the function you want to do:

- Press any letter of the pattern: 'a-i'. At the Main 
  Menu, you will see the description of each option next
  to the letter.
